/*
  ...
  - You are about to drop the column `title` on the `Opinion` table. All the data in the column will be lost.
...
INSERT INTO "new_Opinion" ("authorId", "createdAt", "description", "id", "rate", "storeitemId", "updatedAt") SELECT "authorId", "createdAt", "description", "id", "rate", "storeitemId", "updatedAt" FROM "Opinion";
DROP TABLE "Opinion";
